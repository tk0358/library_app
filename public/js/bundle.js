...
},{}],"addMaterial.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.addMaterial = void 0;
...
var addMaterial = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(_ref) {
    var title, author, publisher, type, libraries, res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            title = _ref.title, author = _ref.author, publisher = _ref.publisher, type = _ref.type, libraries = _ref.libraries;
            _context.prev = 1;
          ...
          case 5:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'You have successfully added a material');
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"borrowing.js":[function(require,module,exports) {
"use strict";
...
var createBorrow = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(material, library, date) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "/api/v1/materials/".concat(material),
              data: {
                status: 'be_borrowing'
              }
            });
          ...
          case 5:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'New borrow is created successfully');
              window.setTimeout(function () {
  ...
  return function createBorrow(_x, _x2, _x3) {
...
var _addMaterial = require("./addMaterial");

var _borrowing = require("./borrowing");
...
var addMaterialForm = document.querySelector('.add-material-form');
var plusBtn = document.querySelector('.plus-btn');
var preBorrowingBtnsPerLibrary = document.querySelectorAll('.pre-borrowing-action-per-lib'); // const borrowingBtnsPerLibrary = document.querySelectorAll(
//   '.borrowing-action-per-lib'
// );

var pushDateToArray = function pushDateToArray(days, objDate) {
  var year = objDate.getFullYear();
  var month = objDate.getMonth() + 1;
  var day = objDate.getDate();
  days.push("".concat(year, "/").concat(month, "/").concat(day));
};

var create4DaysArray = function create4DaysArray() {
  var days = [];
...
if (preBorrowingBtnsPerLibrary) {
  preBorrowingBtnsPerLibrary.forEach(function (btn) {
    return btn.addEventListener('click', function (e) {
      e.preventDefault();
      var days = create4DaysArray(); // console.log(days);
      ...
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          var day = _step.value;
          htmlStr += "<option value=".concat(day, ">").concat(day, "</option>");
        }
      } catch (err) {
        _iterator.e(err);
      } finally {
      ...
      e.target.parentNode.innerHTML = htmlStr; // document
      ...
      document.querySelectorAll('.borrowing-action-per-lib').forEach(function (btn) {
        btn.addEventListener('click', function (e) {
          e.preventDefault();
          var material = e.target.parentNode.parentNode.id;
          var library = e.target.parentNode.parentNode.parentNode.parentNode.dataset.library;
          var date = e.target.previousElementSibling.value; // const library = await Library.find({ name: libraryName });

          console.log(material, library, date);
          (0, _borrowing.createBorrow)(material, library, date);
        });
      });
    });
  });
